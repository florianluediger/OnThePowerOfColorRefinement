...
\begin{figure}[t]
	...
	\begin{tikzpicture}
		\begin{scope}
			\node[main node] (1) {$1$};
			\node[main node] (2) [below left = 0.8cm and 1.4cm of 1]  {$2$};
			\node[main node] (6) [below right = 0.8cm and 1.4cm of 1] {$6$};
			\node[main node] (3) [below = 1.4cm of 2] {$3$};
			\node[main node] (5) [below = 1.4cm of 6] {$5$};
			\node[main node] (4) [below right = 0.8cm and 1.4cm of 3] {$4$};
