...
\begin{figure}[t]
	...
	\begin{tikzpicture}
		\begin{scope}
			\node[main node] (1) [fill=green!30]{};
			\node[main node] (2) [fill=red!30,below left = 0.8cm and 1.4cm of 1]  {};
			\node[main node] (6) [fill=red!30,below right = 0.8cm and 1.4cm of 1] {};
			\node[main node] (3) [fill=red!30,below = 1.4cm of 2] {};
			\node[main node] (5) [fill=red!30,below = 1.4cm of 6] {};
			\node[main node] (4) [fill=green!30,below right = 0.8cm and 1.4cm of 3] {};
			\node[main node] (7) [above = 1.4cm of 1] {};
			\node[main node] (8) [below = 1.4cm of 4] {};
