...
\usepackage[pdftex,pdfpagelabels,hidelinks]{hyperref}       % Hyperlinks im PDF
...
\usepackage[nogroupskip,style=altlist,nopostdot]{glossaries}% Verwaltung des Glossars
...
Veröffentlicht von Springer International Publishing, 2015\\
In Fundamentals of Computation Theory: 20th International Symposium (S. 339-350)\\
...
\input{sec/einfuehrung}

\input{sec/gi_cr}

\input{sec/struktur_lokal}

\input{sec/struktur_global}
